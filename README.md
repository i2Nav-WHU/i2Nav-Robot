...
| :--------------------------------------- | :---------------------------------------: | ------------------------------------------------------------------------------------------------------------------------------------------ | :------------: | :------------------------------------------------------------------------------------: |
| i2Nav INS-Probe<br />(ADIS16465 and F9P) |       🧭GNSS/INS integrated module       | Compact and low-power<br />Built-in MEMS IMU and GNSS module<br />Self-storage system                                                      |       -       |    <img src="resources/sensor/insprobe.jpg" alt="insprobe" style="zoom:25%;" />    |
| Harxon CSX601A                           |             🛰️GNSS antenna             | Full GNSS frequency supported                                                                                                              |       -       |    <img src="resources/sensor/csx601a.jpg" alt="csx601a" style="zoom: 33%;" />    |
| ADI ADIS16465                            |                   🧭IMU                   | 2 °/hr in-run bias stability<br />0.15 °/√hr angular random walk                                                                        |      200      |   <img src="resources/sensor/adis16465.jpg" alt="adis16465" style="zoom:25%;" />   |
| Ublox F9P                                |                 🛰️GNSS                 | Multi-system supported<br />L1/L2 double frequency                                                                                    |       1       |         <img src="resources/sensor/f9p.jpg" alt="f9p" style="zoom:25%;" />         |
| NovAtel OEM719                           |                 🛰️GNSS                 | Multi-system and multi-frequency supported                                                                                           |       1       |      <img src="resources/sensor/oem719.jpg" alt="oem719" style="zoom:25%;" />      |
| AVT Mako-G234 (Stereo)                   |                 📷Camera                 | The resolution is configured as 1600*1200<br />Global shutter<br />Color mode                                                              |       10       |        <img src="resources/sensor/mako.jpg" alt="mako" style="zoom:20%;" />        |
| Livox Mid360<br />(Built-in ICM40609)    |                 ⚡️LiDAR                 | Horizontal: 360°, Vertical: -7°~52°<br />0.1~40 m @ 10% reflectivity<br />Angular Precision < 0.15°<br />Non-repetitive scanning mode |       10       |      <img src="resources/sensor/mid360.jpg" alt="mid360" style="zoom:20%;" />      |
| TDK ICM40609                             |                   🧭IMU                   | 4.5 mdps/√Hz<br />100 ug/√Hz                                                                                                             |      200      |    <img src="resources/sensor/icm40609.jpg" alt="icm40609" style="zoom:25%;" />    |
| Hesai AT128                              |                 ⚡️LiDAR                 | Horizontal: 120°, Vertical: -12.5°~12.9°<br />1~180 m @ 10% reflectivity<br />Angular Precision 0.1° * 0.2°                          |       10       |       <img src="resources/sensor/at128.jpg" alt="at128" style="zoom:15%;" />       |
| Continental ARS548                       |                  📡Radar                  | Horizontal: 120°, Vertical: -20°~20°<br />Distance range: 0.2~300 m<br />Distance accuracy: ±0.15 m<br />Speed accuracy: 0.1 m/s      |       20       |     <img src="resources/sensor/ars548.jpg" alt="ars548" style="zoom: 50%;" />     |
| AgileX Ranger MINI3                      | 🛞Odometer<br />(Wheel speeds and angles) | Speed resolution: 0.001 m/s<br />Angle resolution: 0.001 rad                                                                               |       50       | <img src="resources/sensor/rangermini3.jpg" alt="rangermini3" style="zoom:25%;" /> |
| Cool Shark box                           |             ⏰PTP main clock             | 1.5 us @ 4 hr                                                                                                                              |       -       |  <img src="resources/sensor/coolshark.jpg" alt="rangermini3" style="zoom:25%;" />  |
...
<img src="resources/apriltag.png" alt="apriltag.png" style="zoom: 10%;" />
...
<img src="resources/sensor/goslam.jpg" alt="goslam" style="zoom:60%;" /><img src="resources/pointcloud-map.png" alt="pointcloud-map" style="zoom:50%;" />
